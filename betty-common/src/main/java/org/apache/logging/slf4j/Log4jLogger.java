...
public class Log4jLogger implements LocationAwareLogger, Serializable {
    ...
    public Log4jLogger(final ExtendedLogger logger, final String name) {
    	...
    	if(name.startsWith("io.netty.")) {
    		if("io.netty.handler.logging.LoggingHandler".equals(name)) {
        		fqcn = "io.netty.util.internal.logging.AbstractInternalLogger";
        	} else {
        		fqcn = "io.netty.util.internal.logging.Slf4JLogger";
        	}
    	}
    	//
        this.logger = logger;
